...
ifneq ("$(wildcard $(FACTORY_PATH)/u-boot.bin)","")
	...
	$(hide) $(call aml-copy-install-file, vendor/amlogic/vontarx3/radio/bootloader-console.img, u-boot.bin)
else ifneq ("$(wildcard vendor/amlogic/vontarx3/radio/bootloader.img)","")
	$(hide) $(call aml-copy-install-file, vendor/amlogic/vontarx3/radio/bootloader.img, u-boot.bin)
else
...
ifneq ("$(wildcard $(FACTORY_PATH)/u-boot.bin)","")
	...
	$(hide) $(call aml-copy-upgrade-file, vendor/amlogic/vontarx3/radio/bootloader.img, u-boot.bin)
else
	$(error "no u-boot.bin found in $(FACTORY_PATH)")
endif
